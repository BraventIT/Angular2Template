 ...
 */
import * as fromGlobalUI from './global-ui.reducer';
 ...
 * ```
 */
export const getGlobalUIState = (state: State) => state.globalUI;
 ...
 * pieces of state.
 */
export const getShowSpinner = createSelector(getGlobalUIState, fromGlobalUI.getShowSpinner);
export const getUserInfo = createSelector(getGlobalUIState, fromGlobalUI.getUserInfo);
